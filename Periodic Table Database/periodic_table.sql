...
--
-- Name: elements uniq1; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT uniq1 UNIQUE (symbol);


--
-- Name: elements uniq2; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
